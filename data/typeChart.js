...
/**
 * Get effectiveness multiplier for an attack type against defender types
 * @param {string} attackType - The type of the attacking move
 * @param {string[]} defenderTypes - Array of the defender's types
...
export function getEffectiveness(attackType, defenderTypes) {
  ...
  for (const defType of defenderTypes) {
    if (attackChart[defType] !== undefined) {
